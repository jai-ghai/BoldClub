...
import { Check, Clock3, Crown, Gift, Sparkles } from "lucide-react-native";
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Pressable onPress={() => setShowMembershipPlans((current) => !current)} style={styles.membershipBanner}>
        ...
        <View style={styles.membershipCopy}>
          ...
          <Text style={styles.membershipSubtitle}>See who likes you and unlock more depth</Text>
        </View>
      </Pressable>
        ...
        <View style={styles.giftRow}>
          {digitalGifts.map((gift) => (
            <View key={gift.id} style={styles.giftCard}>
              <Text style={styles.giftIcon}>{gift.icon === "Rose" ? "🌹" : gift.icon === "Coffee" ? "☕" : gift.icon === "Star" ? "⭐" : "💝"}</Text>
...
const styles = StyleSheet.create({
  ...
  giftCard: { flex: 1, borderRadius: 14, backgroundColor: "#F5F5F5", paddingVertical: 14, alignItems: "center" },
  ...
  personalityIconWrap: { width: 46, height: 46, borderRadius: 23, backgroundColor: "#E63946", alignItems: "center", justifyContent: "center", marginBottom: 12 },
  personalityTitle: { color: "#1C1C1C", fontSize: 18, fontWeight: "700" },
  personalitySubtitle: { color: "#6B6B6B", fontSize: 13, marginTop: 4 },
  personalityBody: { color: "#1C1C1C", fontSize: 14, lineHeight: 22, marginTop: 12 },
